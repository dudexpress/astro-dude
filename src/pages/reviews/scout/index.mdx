...
lsgiochi_url: https://www.lsgiochi.it/product/11707129/scout-manuale-in-inglese-indipendente-dalla-lingua
---

<Setting><p>
  <em>    Venghino signori, venghino: il circo è arrivato in città. Trapezisti, equilibristi e la donna cannone sono pronti a
    lasciarvi a bocca aperta. Che aspettate? Accorrete a vedere il miglior circo di sempre!</em>  <br />
  <br />
...
<Rules><p>
  ...
  immaginate una carta francese, ma con due numeri diversi sui due lati corti. <br />A inizio partita, ogni giocatore
  ...
  In ogni turno, un giocatore deve eseguire <strong>una tra queste due azioni</strong>:<br />
  <ul>
    ...
    <li>      <strong>Scout</strong>: si prende una carta da una delle due estremità dalla combinazione presente sul tavolo e la
      ...
      la carta ottiene 1 punto vittoria, a compensazione di una combinazione ora indebolita. <br /></li>
  </ul>
  Una volta per round, un giocatore ha anche la possibilità di eseguire entrambe le azioni consecutivamente: <strong>    scout + show</strong>.<br />
