...
<Rules><p>
  ...
  di difesa), una ultimate (una specie di fatality alla Mortal Kombat), <strong>    un mazzo di carte</strong>, <strong>5 dadi</strong> e dei <strong>token status</strong>.<br />
  ...
  infliggono così i danni. <br />
  L'ultimo eroe a rimanere in piedi vince.
</p></Rules>

![Marvel dice throne](./_game2.jpg)
