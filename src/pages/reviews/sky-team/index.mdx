...
<Feedback><p>
  ...
  un pezzettino, probabilmente fuoriuscito durante il trasporto. Immagino sia stata una scelta per <strong>    diminuire sia l'impatto ambientale</strong>, sia il costo della singola copia… ma c'è un limite, ecco. <br />
