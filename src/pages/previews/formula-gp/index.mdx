...
![Formula GP](./_game1.png)

<Rules><p>
  Lo scopo del gioco è quello di <strong>tagliare il traguardo per primi dopo il 24esimo round</strong>.<br />
  ...
  <br />È possibile superare un avversario senza avviare una battaglia se c’è almeno una corsia che separa i due rivali.
...
<Feedback><p>
  ...
  <strong>Formula GP imposta un nuovo modo di approcciarsi ai giochi di corsa</strong>, proponendosi come
    <strong>un sistema-modello che certamente non potrà più essere ignorato</strong>!<br />
