...
<Rules><p>
  <em>    Le regole che seguono sono da intendersi per una partita in solitario;
    ...
    preparazione e nella gestione del turno.</em>  <br />
  <br />
  ...
  <br />
  Durante il turno, giocheremo una carta dalla nostra mano con l'intento di <strong>    uccidere il nobile di turno</strong>. <br />
