...
<Feedback><p>
  ...
  Il gioco è semplicissimo, soprattutto se avete già giocato a <Link to="/reviews/marvel-dice-throne/">
    Dice Throne
  </Link> ed è un mezzo perfetto per portare curiosi a giocare dopo che si sono innamorati delle <strong>    fantastiche miniature</strong>: sono davvero strepitose! <br />
