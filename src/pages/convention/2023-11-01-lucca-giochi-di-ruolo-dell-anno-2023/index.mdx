...
title: "Lucca Comics - Gioco di ruolo dell'anno 2023"
description: "E insomma questi giochi di ruolo dell'anno?"
---

<FundingIntro>
    <strong>Il mondo del gioco di ruolo</strong> negli ultimi anni <strong>è sensibilmente cambiato</strong>.<br />
...
<ConBit
    ...
    weight={3}
>
    Ecco il primo titolo che ha fatto drizzare le orecchie allo Zio e alla Locandiera.<br />
    ...
    Broken Tales è un <strong>gioco altamente narrativo</strong>, in cui la capacità dei giocatori di <strong>condividere</strong>, creare o elaborare situazioni e scene viene grandemente premiata. Per cui, sbizzarritevi, senza paura!<br />
...
![Broken Tales](./_broken-tales.png)
...
<ConBit
    ...
    weight={3}
>
    Dall’autore di <em>Not the End</em>, con furore, arriva questo nuovo prodotto.<br />
    L’<strong>obiettivo</strong> che <em>Prism</em> si pone è quello di <strong>far affrontare ai giocatori le loro paure e i loro terrori in un mondo distopico</strong>. I personaggi si muoveranno all’interno di una <strong>società deviata</strong>, le cui regole metteranno <strong>a dura prova </strong>la loro <strong>morale</strong> e la loro stessa <strong>sanità mentale</strong>.<br />
    Possiamo sbizzarrirci nella scelta di quale distopia mettere al tavolo, perché <strong>saremo noi i creatori del mondo in cui giocheremo</strong>. <br />
    Parole come Punto di svolta, Paura, Distopia. Cioè! Non vi fa venire l’<strong>acquolina in bocca</strong>?<br />
    <strong>Promette un’esperienza narrativa</strong> <strong>molto interessante</strong> e pensiamo anche <strong>molto</strong> <strong>profonda</strong> se ci si mette in gioco.<br />
...
<ConBit
    ...
    weight={2}
>
    “<strong>Lunga vita al re</strong>” ha esclamato lo Zio nel sentire il titolo (povera Locandiera!).<br />
    Il Re è morto è un <strong>mix equilibrato</strong> <strong>tra un gioco di carte e un gioco di ruolo</strong>: non dovrete far altro che procurarvi un <strong>normalissimo mazzo di bridge</strong> e… sarete pronti!<br />
    La singolarità del gioco sta nel fatto che ogni giocatore avrà il suo <strong>personale libretto</strong> contenente le regole necessarie per giocare e un’infarinatura di informazioni e interessi delle altre casate (per vincere bisogna conoscere l’avversario, no?! E scatta la sigla di GoT). Una volta che ognuno ha letto queste poche pagine si è pronti a giocare. <br />
    E come si fa direte voi? Semplice, esiste un indice di “<strong><em>Scene di Corte</em></strong>” da giocare! Uniche ed irripetibili. <br />
    Se si riesce ad immedesimarsi, il Re è Morto è un gioco che rende moltissimo ed è <strong>perfetto per chi si avvicina al mondo dei giochi di ruolo per la prima volta</strong>: regole semplici, un mazzo di carte come “strumento”. Il resto risiede tutto nel coinvolgimento e nel fare i propri interessi nella maniera migliore e più creativa!<br />
...
![Il re è morto](./_il-re-morto.jpg)
