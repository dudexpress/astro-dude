...
<Rules><p>
  ...
  massimo di quattro o diminuire fino a zero. <br />
  ...
  ingredienti specifici che andranno raccolti nella mappa. <br />
  ...
  ingredienti sono più facili da reperire. <br />
  ...
  avremo vari modi di agire sui cittadini per influenzare l’andamento di un processo. <br />
...
<Feedback><p>
  ...
  stessa casa, come Anachrony e probabilmente il futuro Voidfall. <br />
  ...
  un paio di moduli opzionali che contribuiscono a dare ulteriore varietà al gioco. <br />
  ...
  fare durante il nostro turno. <br />
